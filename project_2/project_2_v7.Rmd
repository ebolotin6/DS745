...
The community generated by the Louvain algorithm looks like it has the cleanest delineation of groups/communities. In the membership table above, the first six groups make up `percent` of total members (all nodes) in the plot. Further analysis of the largest groups reveals:
...
* Group 1 consists of mostly states classified as Southern
* Group 3 consists of mostly larger hub-airports in Alaska
* Group 4 consists of mostly larger regional-airports in Alaska
* Group 8 consists of mostly states classified as Western
...
Null model produces an AIC of 47.2k. A negative coefficient of edges indicates that network density is less than 50%.

## Linkage hypothesis

**Null hypothesis**: Vertex attributes **do not** influence node connectivity/linkage for the population of US airports.

**Alternate hypothesis** : Vertex attributes **do** influence node connectivity/linkage for the population of US airports.
...
The degree terms have been modeled well. However, the dyad-wise partners have not been modeled well - so there is more to be desired from this model.
...
The test model is ~9,000 triangles less than the original/true network. It also has less degrees. But it is much better than the null model.
